    ...
    return (
      <div className="viz-home-container">
        <div className="viz-home-text">
          ...
          <div>
            <a href="https://github.com/markharper" target="_blank">
              <img className="icon" src={"/images/github.png"} />
            </a>
            <a href="https://twitter.com/IAmMarkHarper" target="_blank">
              <img className="icon" src={"/images/twitter.svg"} />
            </a>
            <a href="https://www.linkedin.com/in/mark-harper-06763174/" target="_blank">
